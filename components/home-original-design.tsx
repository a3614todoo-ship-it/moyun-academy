...
export function HomeOriginalDesign({ courses }: { courses: CourseView[] }) {
  return (
    <main className="redesigned-homepage">
      <section className="academy-hero" aria-labelledby="original-home-title">
      ...
      <section className="academy-course-section" id="path" aria-labelledby="original-courses-title">
        <div className="container">
          <div className="academy-section-heading">
            <div>
              <p className="academy-kicker">精選課程</p>
              <h2 id="original-courses-title">此刻，從哪一門課開始？</h2>
            </div>
      ...
      <section className="academy-membership" id="membership" aria-labelledby="original-membership-title">
        <div className="container academy-membership-inner">
          <div>
            <p className="academy-kicker">會員專區</p>
            <h2 id="original-membership-title">加入會員，讓學習成為<br className="desktop-only" />生活裡持續發亮的事</h2>
