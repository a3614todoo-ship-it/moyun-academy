...
const auditLabels: Record<string, string> = {
  ...
  ADMIN_LOGIN_EMAIL_CODE_SENT: "Email 驗證碼已寄出",
  ADMIN_LOGIN_EMAIL_CODE_RESENT: "Email 驗證碼已重新寄送",
  ADMIN_LOGIN_EMAIL_CODE_SEND_FAILED: "Email 驗證碼寄送失敗",
  ADMIN_LOGIN_EMAIL_CODE_SEND_RATE_LIMITED: "Email 驗證碼寄送已限速",
  ADMIN_LOGIN_EMAIL_CODE_FAILED: "Email 驗證碼驗證失敗",
  ADMIN_LOGIN_EMAIL_CODE_RATE_LIMITED: "Email 驗證碼驗證已限速",
