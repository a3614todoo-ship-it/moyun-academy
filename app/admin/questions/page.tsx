...
export default async function QuestionsPage({ searchParams }: Props) {
  ...
  return <AdminShell adminName={session.adminUser.name} adminRole={session.adminUser.role}><div className="admin-page-heading"><div><span>集中回覆、置頂與隱藏</span><h1>課程問答</h1></div></div>
